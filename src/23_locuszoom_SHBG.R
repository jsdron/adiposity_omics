...
# same y-scale for p1 & p2
ymax <- max(loc.pqtl$data$logP, na.rm = TRUE)
...
###### SAVE FIGURE ######
pdf(paste0("/Volumes/medpop_esp2/jdron/projects/adiposity/adiposity_omics/results/figures/manuscript/pdf/Figure5_SHBG-locuszoom.pdf"), 
    width = 3.5, 
    height = 7, 
    family = "Arial") 
cowplot::plot_grid(ap_full[[1]], ap_full[[2]], ap_full[[3]], ap_full[[4]], ncol = 1,  rel_heights = c(1,1,1.05,1.8))
