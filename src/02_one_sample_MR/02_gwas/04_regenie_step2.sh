...
#$ -l h_vmem=12G
#$ -o log/regenie2.log
#$ -e log/regenie2.error.log
#$ -t 22-23

i=$SGE_TASK_ID
chr=$(echo $(echo $(seq 1 22) X) | tr " " "\n" | head -n $i | tail -n 1)

output=/broad/hptmp/jdron/ukb/metab_gwas/ukb-Metab-Aug2022/result/step2/chr${chr}/
mkdir -p ${output}
...
step1=/broad/hptmp/jdron/ukb/metab_gwas/ukb-Metab-Aug2022/result/step1/combined_pred_added.list
