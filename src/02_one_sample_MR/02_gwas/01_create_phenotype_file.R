...
write.table(gwas_df, # 96613
            file = "/Volumes/medpop_esp2/jdron/projects/adiposity/adiposity_omics/src/02_one_sample_MR/02_gwas/data/metab_gwas.PHENO.n96613.20240123.tsv", 
...
write.table(list, # 96613
            file = "/Volumes/medpop_esp2/jdron/projects/adiposity/adiposity_omics/src/02_one_sample_MR/02_gwas/data/metab_gwas.list.txt", 
            sep= "\t", col.names= T, row.names = F, quote = F)
...
write.table(gwas_df, # 96613
            file = "/Volumes/medpop_esp2/jdron/projects/adiposity/adiposity_omics/src/02_one_sample_MR/02_gwas/data/metab_gwas.COVAR.n96613.20240123.tsv", 
            sep= "\t", col.names= T, row.names = F, quote = F)
